...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const HomePageWidget() : const InicioWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          builder: (context, params) => ProdutoWidget(
            referenciaProduto: params.getParam('referenciaProduto',
                ParamType.DocumentReference, false, ['plantas']),
          ),
        ),
        FFRoute(
          name: 'Carrinho',
